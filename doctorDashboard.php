...
<div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(200 13 125);">
            ...
            <div class="dashboard-main-card">
                    ...
                    <div id="doctor-details">
                        <div style="display:flex"> 
                            <div style="color:#6592e6; font-size: 1.3rem; font-weight:500;margin-right:10px">Patient Name: </div>
                            <?php
                           
                          
                             echo "<div style='font-size: 1.3rem;'>$name</div>";
                            ?>
                        </div>
                        <div style="display:flex">
                            <div style="color:#6592e6; font-size: 1.3rem; font-weight:500;margin-right:10px">Hospital Name: </div>
                            <div div style="font-size: 1.3rem;"> Ram Narayan Hospital, G.E. Road, Raipur</div>
                        </div>
                    </div>
   ...
   <form id="patient-dashboard" style="display:block;" method="post">
            <div class="dashboard-main-card" style="display:block">
                ...
                <br/>
                <center><button type="submit" class="btn btn-primary" name="submit">Add Prescription</button></center>
            </div>
   </form>
